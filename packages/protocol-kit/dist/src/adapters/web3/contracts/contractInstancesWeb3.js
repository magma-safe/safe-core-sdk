...
const CompatibilityFallbackHandler_V1_4_1_Web3_1 = __importDefault(
  require('./CompatibilityFallbackHandler/v1.4.1/CompatibilityFallbackHandler_V1_4_1_Web3')
)
...
const CreateCallEthersContract_V1_4_1_Web3_1 = __importDefault(
  require('./CreateCall/v1.4.1/CreateCallEthersContract_V1_4_1_Web3')
)
...
const MultiSendContract_V1_4_1_Web3_1 = __importDefault(
  require('./MultiSend/v1.4.1/MultiSendContract_V1_4_1_Web3')
)
...
const MultiSendCallOnlyContract_V1_4_1_Web3_1 = __importDefault(
  require('./MultiSendCallOnly/v1.4.1/MultiSendCallOnlyContract_V1_4_1_Web3')
)
const SafeContract_V1_0_0_Web3_1 = __importDefault(
  require('./Safe/v1.0.0/SafeContract_V1_0_0_Web3')
)
const SafeContract_V1_1_1_Web3_1 = __importDefault(
  require('./Safe/v1.1.1/SafeContract_V1_1_1_Web3')
)
const SafeContract_V1_2_0_Web3_1 = __importDefault(
  require('./Safe/v1.2.0/SafeContract_V1_2_0_Web3')
)
const SafeContract_V1_3_0_Web3_1 = __importDefault(
  require('./Safe/v1.3.0/SafeContract_V1_3_0_Web3')
)
const SafeContract_V1_4_1_Web3_1 = __importDefault(
  require('./Safe/v1.4.1/SafeContract_V1_4_1_Web3')
)
const SafeProxyFactoryContract_V1_0_0_Web3_1 = __importDefault(
  require('./SafeProxyFactory/v1.0.0/SafeProxyFactoryContract_V1_0_0_Web3')
)
const SafeProxyFactoryContract_V1_1_1_Web3_1 = __importDefault(
  require('./SafeProxyFactory/v1.1.1/SafeProxyFactoryContract_V1_1_1_Web3')
)
const SafeProxyFactoryContract_V1_3_0_Web3_1 = __importDefault(
  require('./SafeProxyFactory/v1.3.0/SafeProxyFactoryContract_V1_3_0_Web3')
)
const SafeProxyFactoryContract_V1_4_1_Web3_1 = __importDefault(
  require('./SafeProxyFactory/v1.4.1/SafeProxyFactoryContract_V1_4_1_Web3')
)
...
const SignMessageLibContract_V1_4_1_Web3_1 = __importDefault(
  require('./SignMessageLib/v1.4.1/SignMessageLibContract_V1_4_1_Web3')
)
const SimulateTxAccessorContract_V1_3_0_Web3_1 = __importDefault(
  require('./SimulateTxAccessor/v1.3.0/SimulateTxAccessorContract_V1_3_0_Web3')
)
const SimulateTxAccessorContract_V1_4_1_Web3_1 = __importDefault(
  require('./SimulateTxAccessor/v1.4.1/SimulateTxAccessorContract_V1_4_1_Web3')
)
...
function getCompatibilityFallbackHandlerContractInstance(
  ...
  switch (safeVersion) {
    case '1.4.1':
      return new CompatibilityFallbackHandler_V1_4_1_Web3_1.default(
        compatibilityFallbackhandlerContract
      )
    case '1.3.0':
    case '1.2.0':
